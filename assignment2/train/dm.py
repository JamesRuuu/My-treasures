...
new_data.loc[:, cate].isnull().mean()

# 创造新变量in_company和in_agent对旅客分类,company和agent为0的设为NO,非0的为YES
# new_data.loc[new_data['company'] == 0, 'in_company'] = 0  # no
# new_data.loc[new_data['company'] != 0, 'in_company'] = 1  # yes
# new_data.loc[new_data['agent'] == 0, 'in_agent'] = 0
# new_data.loc[new_data['agent'] != 0, 'in_agent'] = 1
...
# new_data.loc[new_data['reserved_room_type'] == new_data['assigned_room_type'],'same_assignment'] = 1
# new_data.loc[new_data['reserved_room_type'] != new_data['assigned_room_type'],'same_assignment'] = 0
...
# new_data[new_data['is_repeated_guest'] == 0] = 'NO'
# new_data[new_data['is_repeated_guest'] == 1] = 'YES'
...
new_df.loc[new_df['deposit_type'] == 1, 'new_rf'] = 1
new_df.loc[new_df['deposit_type'] == 2, 'new_nr'] = 1
...
print(association_rules(frequent_itemsets,metric='lift'))
